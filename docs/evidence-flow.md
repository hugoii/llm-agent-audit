...
If the first existing or synthetic trace cannot show enough runtime evidence,
the output is an evidence-readiness gap map and a minimal instrumentation plan.
It is not treated as a full trace-backed authorization verdict.
