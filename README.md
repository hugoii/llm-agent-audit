...
- **[AP L3-L5 control experiment](docs/ap-l3-l5-control-experiment.md)**: a narrow method note showing post-approval mutation, inter-agent handoff, retry/idempotency, benign controls, and missing-evidence verdicts.
