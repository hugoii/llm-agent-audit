...
The harness, battery, and per-configuration summaries used in this report are available at \url{https://github.com/hugoii/llm-agent-audit}. The v1.5.0 Zenodo version archive is available at \url{https://doi.org/10.5281/zenodo.20585659}. The version-independent concept DOI, used by the repository README and citation metadata, is \url{https://doi.org/10.5281/zenodo.20585658}.
